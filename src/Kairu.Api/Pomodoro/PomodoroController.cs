using Kairu.Application.Pomodoro.Commands.CompleteSession;
using Kairu.Application.Pomodoro.Commands.CreateTaskDuringSession;
using Kairu.Application.Pomodoro.Commands.InterruptSession;
using Kairu.Application.Pomodoro.Commands.LinkTask;
using Kairu.Application.Pomodoro.Commands.SaveSettings;
using Kairu.Application.Pomodoro.Commands.StartSession;
using Kairu.Application.Pomodoro.Commands.UpdateTaskStatus;
using Kairu.Application.Pomodoro.Queries.GetCurrentSession;
using Kairu.Application.Pomodoro.Queries.GetSettings;
using Kairu.Application.Pomodoro.Queries.GetSuggestedSessionType;
using Kairu.Application.Pomodoro.Queries.GetTodaySprintSessions;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;
using Monbsoft.BrilliantMediator.Abstractions;

namespace Kairu.Api.Pomodoro;
