using Kairu.Application.Journal.CreateJournalEntry;
using Kairu.Application.Tasks.ChangeTaskStatus;
using Kairu.Application.Tasks.Common;
using Kairu.Domain.Tasks;
using DomainTaskStatus = Kairu.Domain.Tasks.TaskStatus;

namespace Kairu.Application.Tests.Tasks;
